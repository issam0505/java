...
## 🎯 Objectifs du Projet
- Centraliser la gestion des données pharmaceutiques  
- Automatiser les tâches répétitives (stocks, ventes, commandes)  
- Assurer un suivi précis et en temps réel des opérations  
- Fournir des rapports fiables pour aider à la prise de décision  
...
- Gestion des utilisateurs et des rôles (administrateur, pharmacien, client)
...
Un fichier SQL est fourni pour créer et initialiser la base de données.
